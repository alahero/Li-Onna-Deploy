...
import { GiftcardsHero } from '@/components/giftcards-hero';
import { GiftcardsMarquee } from '@/components/giftcards-marquee';
...
/**
 * Página de tarjetas regalo: hero azul (cinta + vidrio + tarjetas) y carril de texto bajo el hero.
 */
export default function GiftCardsPage() {
  return (
    <>
      ...
      <main style={{ backgroundColor: '#F6F6F2', minHeight: '100vh' }}>
        <GiftcardsHero />
        <GiftcardsMarquee />
